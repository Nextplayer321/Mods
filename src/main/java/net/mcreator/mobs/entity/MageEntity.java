...
import net.mcreator.mobs.entity.renderer.MageRenderer;
import net.mcreator.mobs.MobsModElements;

@MobsModElements.ModElement.Tag
public class MageEntity extends MobsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("mage").setRegistryName("mage");
	public MageEntity(MobsModElements instance) {
		super(instance, 6);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MageRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -13159, -10079233, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("mage_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.REDSTONE));
		}
