...
import net.mcreator.mobs.entity.renderer.BirdRenderer;
import net.mcreator.mobs.MobsModElements;

import java.util.Random;

@MobsModElements.ModElement.Tag
public class BirdEntity extends MobsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.5f)).build("bird").setRegistryName("bird");
	public BirdEntity(MobsModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -6724096, -13312, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("bird_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(10, new TemptGoal(this, 0.8, Ingredient.fromItems(Items.WHEAT_SEEDS), false));
		}
